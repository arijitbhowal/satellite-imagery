...
parser.add_argument('--Fsplit', type=str,help='path destination for Fsplit folder')
parser.add_argument('--xys', type=str,help='path destination for xys folder')
parser.add_argument('--patch_size', type=int, default=32,help='dimensions of the patch size you wish to use')
parser.add_argument('--nb_dates', type=int, default=19,help='number of available dates')
